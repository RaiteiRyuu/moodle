...
class __Mustache_2f6f46a04dd7a01d9fc54ba93ee814ac extends Mustache_Template
{
...
';
        // 'hasblocks' section
        $value = $context->find('hasblocks');
        $buffer .= $this->sectionC6eb96feac8b1e18fb68904512a3cd73($context, $indent, $value);
        $buffer .= $indent . '            </div>
';
        $buffer .= $indent . '        </div>
';
...
';
    ...
    private function sectionC6eb96feac8b1e18fb68904512a3cd73(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
