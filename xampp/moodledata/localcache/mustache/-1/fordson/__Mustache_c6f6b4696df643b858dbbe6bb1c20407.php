...
class __Mustache_c6f6b4696df643b858dbbe6bb1c20407 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section5e5d088afbbeff8fc11c4801185209b4($context, $indent, $value);
        $buffer .= $indent . '        </nav>
';
        $buffer .= $indent . '        ';
...
';
    ...
    private function section5e5d088afbbeff8fc11c4801185209b4(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
